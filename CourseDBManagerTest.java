...
public class CourseDBManagerTest {
	...
	public void testShowAll() {
		dataMgr.add("CMSC203",30503,4,"SC450","Joey Bag-O-Donuts");
		dataMgr.add("CMSC203",30504,4,"SC450","Jill B. Who-Dunit");
		dataMgr.add("CMSC204",30559,4,"SC450","BillyBob Jones");
		ArrayList<String> list = dataMgr.showAll();
		
		assertEquals(list.get(0),"\nCourse:CMSC203 CRN:30503 Credits:4 Instructor:Joey Bag-O-Donuts Room:SC450");
		assertEquals(list.get(1),"\nCourse:CMSC203 CRN:30504 Credits:4 Instructor:Jill B. Who-Dunit Room:SC450");
